export default {
  ...
  'menu.profile': '课程详情',
  'menu.profile.maina': '课程管理',
  'menu.profile.main': '课程信息',
  'menu.profile.basica': '作业管理',
  'menu.profile.basic': '作业',
  'menu.profile.downloada': '课件管理',
  'menu.profile.download': '下载',
  'menu.profile.exama': '实验管理',
  'menu.profile.exam': '实验',
  'menu.profile.advanced': '高级详情页',
  'menu.profile.chat': '课程讨论',
  'menu.result': '结果页',
